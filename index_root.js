...
const UUID = process.env.UUID || '95201e7e-607f-47d1-aa65-09d678c6225b'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'elox';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'p2u';                    // 节点名称
const PORT = process.env.PORT || 9683;                     // http和ws服务端口
